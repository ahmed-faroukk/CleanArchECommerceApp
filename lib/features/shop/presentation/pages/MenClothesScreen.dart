...
class MenClothScreen extends StatefulWidget {
  const MenClothScreen({Key? key}) : super(key: key);

  @override
  State<MenClothScreen> createState() => _MenClothScreenState();
}

class _MenClothScreenState extends State<MenClothScreen> {
  @override
  ...
  Widget buildPopularScreen() {
    return BlocProvider<RemoteProductBloc>(
      create: (context) => s1()..add(const GetMenProducts()),
      child: MaterialApp(
