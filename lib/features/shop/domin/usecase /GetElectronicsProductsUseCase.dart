...
class GetElectronicsProductsUseCase implements  UseCase<Resource<List<ProductsEntity>>, void>  {
  final ShopRepo repo;
  GetElectronicsProductsUseCase(this.repo);


  @override
  Future<Resource<List<ProductsEntity>>> invoke({void params}) {
    return repo.getProductsByCategory(CATEGORIES[2]);
  }
