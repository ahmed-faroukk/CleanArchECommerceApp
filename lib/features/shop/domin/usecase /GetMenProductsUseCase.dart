...
class GetMensProductsUseCase implements  UseCase<Resource<List<ProductsEntity>>, void>  {
  final ShopRepo repo;
  GetMensProductsUseCase(this.repo);


  @override
  Future<Resource<List<ProductsEntity>>> invoke({void params}) {
    return repo.getProductsByCategory(CATEGORIES[0]);
  }
